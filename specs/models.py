...
class CategoryFeature(models.Model):
    ...
    feature_filter_name = models.CharField(verbose_name='Название фильтра', max_length=50)
...
class FeatureValidator(models.Model):
    ...
    valid_feature_value = models.CharField(max_length=100, verbose_name='Допустимое значение')

    def __str__(self):
        return f"Категория {self.category.name} | " \
               f"Характристика {self.feature_key.feature_name} | " \
               f"Допустимое значение {self.valid_feature_value}"
